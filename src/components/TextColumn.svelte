...
<div id="right-column">
    <div id="intro" class="step">
        <p>Mayor Ken Sim has been marked absent on city council votes far more often than previous mayors – and his own council colleagues, too.</p>
    ...
    <div id="summer24" class="step">
        <p>Sim missed 114 votes in the summer of 2024 – the most intense period of votes missed in his tenure so far.</p>
    </div>
</div>
